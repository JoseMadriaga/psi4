...
class Libint2F12_STG : public Libint2TwoElectronInt {
    public:
     Libint2F12_STG(double zeta, const IntegralFactory* integral, double screening_threshold, int deriv = 0,
                   bool use_shell_pairs = false);
     ~Libint2F12_STG() override;
     Libint2F12_STG* clone() const override { return new Libint2F12_STG(*this); }
...
class Libint2F12 : public Libint2TwoElectronInt {
    public:
     Libint2F12(std::vector<std::pair<double,double>> cgtg_params, const IntegralFactory* integral, double screening_threshold, int deriv = 0,
                   bool use_shell_pairs = false);
     ~Libint2F12() override;
...
class Libint2F12G12 : public Libint2TwoElectronInt {
    public:
     Libint2F12G12(std::vector<std::pair<double,double>> cgtg_params, const IntegralFactory* integral, double screening_threshold, int deriv = 0,
                   bool use_shell_pairs = false);
