...
void Libint2ErfERI::libint2_wrapper0(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
    ...
    switch (braket_) {
        case libint2::BraKet::xx_xx:
            engines_[0].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xx_xx, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        case libint2::BraKet::xs_xx:
            engines_[0].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xs_xx, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        case libint2::BraKet::xx_xs:
            engines_[0].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xx_xs, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        case libint2::BraKet::xs_xs:
            engines_[0].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xs_xs, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        default:
...
void Libint2ErfERI::libint2_wrapper1(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
    ...
    switch (braket_) {
        case libint2::BraKet::xx_xx:
            engines_[1].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xx_xx, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        case libint2::BraKet::xs_xx:
            engines_[1].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xs_xx, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        case libint2::BraKet::xx_xs:
            engines_[1].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xx_xs, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        case libint2::BraKet::xs_xs:
            engines_[1].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xs_xs, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        default:
...
void Libint2ErfERI::libint2_wrapper2(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
    ...
    switch (braket_) {
        case libint2::BraKet::xx_xx:
            engines_[2].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xx_xx, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        case libint2::BraKet::xs_xx:
            engines_[2].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xs_xx, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        case libint2::BraKet::xx_xs:
            engines_[2].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xx_xs, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        case libint2::BraKet::xs_xs:
            engines_[2].compute2<libint2::Operator::erf_coulomb, libint2::BraKet::xs_xs, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
            break;
        default:
...
Libint2F12_STG::Libint2F12_STG(double zeta, const IntegralFactory *integral, double screening_threshold, int deriv, 
                                     bool use_shell_pairs)
     : Libint2TwoElectronInt(integral, deriv, screening_threshold, use_shell_pairs) {
     timer_on("Libint2F12_STG::Libint2F12_STG");
     int max_am =
         std::max(std::max(basis1()->max_am(), basis2()->max_am()), std::max(basis3()->max_am(), basis4()->max_am()));
     int max_nprim = std::max(std::max(basis1()->max_nprimitive(), basis2()->max_nprimitive()),
                              std::max(basis3()->max_nprimitive(), basis4()->max_nprimitive()));
     ...
     for (int der = 0; der <= deriv; ++der) {
         // set braket upon engine construction so particular LIBINT2_MAX_AM_eri[|2|3] limit governs validity
         engines_.emplace_back(libint2::Operator::stg, max_nprim, max_am, der, max_precision, zeta, braket_);
     }
     // set max_am for primary basis to be sieved, not all basis1234
     max_am = bra_same_ ? basis1()->max_am() : ket_same_ ? basis3()->max_am() : 0;
     schwarz_engine_ = libint2::Engine(libint2::Operator::stg, max_nprim, max_am, 0, max_precision, zeta, libint2::BraKet::xx_xx);
     common_init();
     timer_on("\nLibint2F12_STG::Libint2F12_STG");
 }

 void Libint2F12_STG::libint2_wrapper0(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
                                     const libint2::Shell &sh4, const libint2::ShellPair *sp12, const libint2::ShellPair *sp34) {
     switch (braket_) {
         case libint2::BraKet::xx_xx:
             engines_[0].compute2<libint2::Operator::stg, libint2::BraKet::xx_xx, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xx:
             engines_[0].compute2<libint2::Operator::stg, libint2::BraKet::xs_xx, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xx_xs:
             engines_[0].compute2<libint2::Operator::stg, libint2::BraKet::xx_xs, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xs:
             engines_[0].compute2<libint2::Operator::stg, libint2::BraKet::xs_xs, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         default:
             throw PSIEXCEPTION("Bad BraKet type in Libint2F12_STG::libint2wrapper0");
     }
 }

 void Libint2F12_STG::libint2_wrapper1(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
                                     const libint2::Shell &sh4, const libint2::ShellPair *sp12, const libint2::ShellPair *sp34) {
     switch (braket_) {
         case libint2::BraKet::xx_xx:
             engines_[1].compute2<libint2::Operator::stg, libint2::BraKet::xx_xx, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xx:
             engines_[1].compute2<libint2::Operator::stg, libint2::BraKet::xs_xx, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xx_xs:
             engines_[1].compute2<libint2::Operator::stg, libint2::BraKet::xx_xs, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xs:
             engines_[1].compute2<libint2::Operator::stg, libint2::BraKet::xs_xs, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         default:
             throw PSIEXCEPTION("Bad BraKet type in Libint2F12_STG::libint2wrapper1");
     }
 }
 void Libint2F12_STG::libint2_wrapper2(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
                                     const libint2::Shell &sh4, const libint2::ShellPair *sp12, const libint2::ShellPair *sp34) {
     switch (braket_) {
         case libint2::BraKet::xx_xx:
             engines_[2].compute2<libint2::Operator::stg, libint2::BraKet::xx_xx, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xx:
             engines_[2].compute2<libint2::Operator::stg, libint2::BraKet::xs_xx, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xx_xs:
             engines_[2].compute2<libint2::Operator::stg, libint2::BraKet::xx_xs, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xs:
             engines_[2].compute2<libint2::Operator::stg, libint2::BraKet::xs_xs, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         default:
             throw PSIEXCEPTION("Bad BraKet type in Libint2F12_STG::libint2wrapper2");
     }
 }

Libint2F12_STG::~Libint2F12_STG(){};

Libint2F12::Libint2F12(std::vector<std::pair<double,double>> cgtg_params, const IntegralFactory *integral, double screening_threshold, int deriv,
                                     bool use_shell_pairs)
     : Libint2TwoElectronInt(integral, deriv, screening_threshold, use_shell_pairs) {
     ...
     for (int der = 0; der <= deriv; ++der) {
         // set braket upon engine construction so particular LIBINT2_MAX_AM_eri[|2|3] limit governs validity
         engines_.emplace_back(libint2::Operator::cgtg, max_nprim, max_am, der, max_precision, cgtg_params, braket_);
     }

     // set max_am for primary basis to be sieved, not all basis1234
     max_am = bra_same_ ? basis1()->max_am() : ket_same_ ? basis3()->max_am() : 0;
     schwarz_engine_ = libint2::Engine(libint2::Operator::cgtg, max_nprim, max_am, 0, max_precision, cgtg_params, libint2::BraKet::xx_xx);
     common_init();
...
Libint2F12G12::Libint2F12G12(std::vector<std::pair<double,double>> cgtg_params, const IntegralFactory *integral, double screening_threshold, int deriv,
                                     bool use_shell_pairs)
     : Libint2TwoElectronInt(integral, deriv, screening_threshold, use_shell_pairs) {
     ...
     for (int der = 0; der <= deriv; ++der) {
         // set braket upon engine construction so particular LIBINT2_MAX_AM_eri[|2|3] limit governs validity
         engines_.emplace_back(libint2::Operator::cgtg_x_coulomb, max_nprim, max_am, der, max_precision, cgtg_params, braket_);
     }

     // set max_am for primary basis to be sieved, not all basis1234
     max_am = bra_same_ ? basis1()->max_am() : ket_same_ ? basis3()->max_am() : 0;
     schwarz_engine_ = libint2::Engine(libint2::Operator::cgtg_x_coulomb, max_nprim, max_am, 0, max_precision, cgtg_params, libint2::BraKet::xx_xx);
     common_init();
 ...
 void Libint2F12G12::libint2_wrapper0(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
     ...
     switch (braket_) {
         case libint2::BraKet::xx_xx:
             engines_[0].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xx_xx, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xx:
             engines_[0].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xs_xx, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xx_xs:
             engines_[0].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xx_xs, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xs:
             engines_[0].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xs_xs, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         default:
 ...
 void Libint2F12G12::libint2_wrapper1(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
     ...
     switch (braket_) {
         case libint2::BraKet::xx_xx:
             engines_[1].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xx_xx, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xx:
             engines_[1].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xs_xx, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xx_xs:
             engines_[1].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xx_xs, 1>(sh1, sh2, sh3, sh4, sp12, sp34);

             break;
         case libint2::BraKet::xs_xs:
             engines_[1].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xs_xs, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         default:
 ...
 void Libint2F12G12::libint2_wrapper2(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
     ...
     switch (braket_) {
         case libint2::BraKet::xx_xx:
             engines_[2].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xx_xx, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xx:
             engines_[2].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xs_xx, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xx_xs:
             engines_[2].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xx_xs, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xs:
             engines_[2].compute2<libint2::Operator::cgtg_x_coulomb, libint2::BraKet::xs_xs, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         default:
...
Libint2F12DoubleCommutator::Libint2F12DoubleCommutator(std::vector<std::pair<double,double>> cgtg_params, const IntegralFactory *integral, double screening_threshold, int deriv,
                                     bool use_shell_pairs)
     : Libint2TwoElectronInt(integral, deriv, screening_threshold, use_shell_pairs) {
     ...
     for (int der = 0; der <= deriv; ++der) {
         // set braket upon engine construction so particular LIBINT2_MAX_AM_eri[|2|3] limit governs validity
         engines_.emplace_back(libint2::Operator::delcgtg2, max_nprim, max_am, der, max_precision, cgtg_params, braket_);
     }

     // set max_am for primary basis to be sieved, not all basis1234
     max_am = bra_same_ ? basis1()->max_am() : ket_same_ ? basis3()->max_am() : 0;
     schwarz_engine_ = libint2::Engine(libint2::Operator::delcgtg2, max_nprim, max_am, 0, max_precision, cgtg_params, libint2::BraKet::xx_xx);
     common_init();
     timer_on("\nLibint2F12DoubleCommutator::Libint2F12DoubleCommutator");
 }

 void Libint2F12DoubleCommutator::libint2_wrapper0(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
                                     const libint2::Shell &sh4, const libint2::ShellPair *sp12, const libint2::ShellPair *sp34) {
     switch (braket_) {
         case libint2::BraKet::xx_xx:
             engines_[0].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xx_xx, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xx:
             engines_[0].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xs_xx, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xx_xs:
             engines_[0].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xx_xs, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xs:
             engines_[0].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xs_xs, 0>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         default:
 ...
 void Libint2F12DoubleCommutator::libint2_wrapper1(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
                                     const libint2::Shell &sh4, const libint2::ShellPair *sp12, const libint2::ShellPair *sp34) {
     switch (braket_) {
         case libint2::BraKet::xx_xx:
             engines_[1].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xx_xx, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xx:
             engines_[1].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xs_xx, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xx_xs:
             engines_[1].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xx_xs, 1>(sh1, sh2, sh3, sh4, sp12, sp34);

             break;
         case libint2::BraKet::xs_xs:
             engines_[1].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xs_xs, 1>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         default:
 ...
 void Libint2F12DoubleCommutator::libint2_wrapper2(const libint2::Shell &sh1, const libint2::Shell &sh2, const libint2::Shell &sh3,
                                     const libint2::Shell &sh4, const libint2::ShellPair *sp12, const libint2::ShellPair *sp34) {
     switch (braket_) {
         case libint2::BraKet::xx_xx:
             engines_[2].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xx_xx, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xx:
             engines_[2].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xs_xx, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xx_xs:
             engines_[2].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xx_xs, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         case libint2::BraKet::xs_xs:
             engines_[2].compute2<libint2::Operator::delcgtg2, libint2::BraKet::xs_xs, 2>(sh1, sh2, sh3, sh4, sp12, sp34);
             break;
         default:
